...
| 🏆 Achievement | 💡 Detail |
|:---|:---|
| 📱 **10+ App Store Apps** | Built, shipped & maintained production iOS apps end-to-end |
| ⚡ **5+ Years iOS Experience** | Deep expertise in Swift, SwiftUI, UIKit in real-world products |
| 🔁 **Full Lifecycle Ownership** | Design → Code → CI/CD → App Store release |
| 🧱 **Modular Architecture** | Scalable, maintainable iOS codebases at team scale |
| 🔥 **Firebase Suite** | Auth · Firestore · Realtime DB · Analytics · Crashlytics |
| 🎯 **Performance Focused** | Memory-safe, lag-free experiences with Instruments profiling |
...
<div align="center">
  <img height="170" src="https://github-readme-stats.vercel.app/api?username=AkshaySharma2230&show_icons=true&theme=tokyonight&hide_border=true&count_private=true&rank_icon=github&include_all_commits=true" />
  <img height="170" src="https://github-readme-stats.vercel.app/api/top-langs/?username=AkshaySharma2230&layout=compact&theme=tokyonight&hide_border=true&langs_count=6" />
</div>
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/akshay-sharma-351920118)
...
let akshay = iOSDeveloper(
    ...
    company:           "MaasErp Solutions Pvt Ltd",
    stack:             ["Swift", "SwiftUI", "UIKit", "Firebase", "Combine"],
    architecture:      ["MVVM", "Modular", "TCA (learning)"],
    appsShipped:       10,
    yearsExperience:   5,
    Currently Learning: "Modular Architecture & TCA",
